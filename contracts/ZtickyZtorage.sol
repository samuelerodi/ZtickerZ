...
//
// import './old/Backend.sol';
// import './old/MarketInterface.sol';
...
//  */
// contract ZtickyZtorage is  HasNoEther, Backend(address(0)), ERC721Full("ZtickyZtorage", "ZSZ")  {
//
//   /**
...
//     ERC721Full._mint(_owner, _stickerId);
...
//     ERC721Full._burn(tx.origin, _stickerId);
...
//   public
//   returns (uint256) {
//     ERC721Full.approve(frontend, _stickerId);
...
//     ERC721Full._clearApproval(_owner, _stickerId);
